...
'MIT License. Copyright © 2024 MatheusNReis
    ...
    For i = i To LastRowPlanWorks
        ...
        If works.Cells(i, MediaRetrorrefletancia).MergeArea.Cells(1, 1).Value = "" Then 'Condição criada caso a célula esteja vazia não interromperá o código
        ...
        End If
        If works.Cells(i, MinimaRetrorrefletancia).MergeArea.Cells(1, 1).Value = "" Then 'Condição criada caso a célula esteja vazia não interromperá o código
