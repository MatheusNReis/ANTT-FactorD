...
'SinHZ Marcas_Legendas - Fator D.xlsm
    ...
    For i = i To LastRowPlanWorks
        ...
        'For j = FirstLineReferencia To LastLineReferencia
            If works.Cells(i, MediaRetrorrefletancia).Value < MinimaRetrorrefletancia Then
                ...
                ThisWorkbook.Sheets("Compilado").Cells(linhaPlanCompilado, "D").Value = Rodovia
                ThisWorkbook.Sheets("Compilado").Cells(linhaPlanCompilado, "E").Value = works.Cells(i, FaixaSinalizacao).MergeArea.Cells(1, 1).Value
                ThisWorkbook.Sheets("Compilado").Cells(linhaPlanCompilado, "F").Value = works.Cells(i, MediaRetrorrefletancia).MergeArea.Cells(1, 1).Value
                ThisWorkbook.Sheets("Compilado").Cells(linhaPlanCompilado, "G").Value = MinimaRetrorrefletancia
                ThisWorkbook.Sheets("Compilado").Cells(linhaPlanCompilado, "H").Value = "Não atende"
